...
-- Shell init:
export CLASSPATH=$CLASSPATH:'/Users/swallan/OneDrive - California Polytechnic State University/z Fourth Year 2021-22/csc365/lab7/JDBCSampleCode/mysql-connector-java-8.0.16.jar:.'
export HP_JDBC_URL=jdbc:mysql://db.labthreesixfive.com/swallan?autoReconnect=true\&useSSL=false
export HP_JDBC_USER=swallan
export HP_JDBC_PW=csc365-F2021_016234760
 */
